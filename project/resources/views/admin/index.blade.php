                ...
                <div class="row bg-white has-shadow">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="title"><span>Editor<br>Requests</span>
                                <div class="progress">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="title"><span>Open<br>Courses</span>
                                <div class="progress">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="title"><span>New<br>Documents</span>
                                <div class="progress">
                ...
                <div class="row">
                    ...
                    <div class="chart col-lg-6 col-12">
                        <div
                            ...
                            <canvas id="lineCahrt">
                                @if(true)
                                <script type="text/javascript">var chart_visitors ={{json_encode($visitors)}};
                                    var chart_viewers ={{json_encode($viewers)}};
                                    var label_month ={{json_encode($label_month)}};
                                </script>
            ...
            <div class="container-fluid">
                    ...
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="{{asset('admin/img/project-1.jpg')}}" alt="..."
                                                                   class="img-fluid"></div>
                                <div class="text">
                ...
                <div class="project">
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="{{asset('admin/img/project-2.jpg')}}" alt="..."
                                                                   class="img-fluid"></div>
                                <div class="text">
                                    <h3 class="h4">Project Title</h3>
                                    <small>Lorem Ipsum Dolor</small>
                ...
                <div class="project">
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="{{asset('admin/img/project-3.jpg')}}" alt="..."
                                                                   class="img-fluid"></div>
                                <div class="text">
                                    <h3 class="h4">Project Title</h3>
                                    <small>Lorem Ipsum Dolor</small>
                ...
                <div class="project">
                    <div class="row bg-white has-shadow">
                        <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                            <div class="project-title d-flex align-items-center">
                                <div class="image has-shadow"><img src="{{asset('admin/img/project-4.jpg')}}" alt="..."
                                                                   class="img-fluid"></div>
                                <div class="text">
                                    <h3 class="h4">Project Title</h3>
                                    <small>Lorem Ipsum Dolor</small>
                    ...
                    <div class="col-lg-4">
                        <div class="client card">
                            ...
                            <div class="card-body text-center">
                                <div class="client-avatar"><img src="{{asset('admin/img/avatar-2.jpg')}}" alt="..."
                    ...
                    <div class="col-lg-6">
                        <div class="articles card">
                            ...
                            <div class="card-body no-padding">
                                <div class="item d-flex align-items-center">
                                    <div class="image"><img src="{{asset('admin/img/avatar-1.jpg')}}" alt="..."
                                ...
                                <div class="item d-flex align-items-center">
                                    <div class="image"><img src="{{asset('admin/img/avatar-2.jpg')}}" alt="..."
                                                            class="img-fluid rounded-circle"></div>
                                    <div class="text"><a href="#">
                                            <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                                ...
                                <div class="item d-flex align-items-center">
                                    <div class="image"><img src="{{asset('admin/img/avatar-3.jpg')}}" alt="..."
                                                            class="img-fluid rounded-circle"></div>
                                    <div class="text"><a href="#">
                                            <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                                ...
                                <div class="item d-flex align-items-center">
                                    <div class="image"><img src="{{asset('admin/img/avatar-4.jpg')}}" alt="..."
                                                            class="img-fluid rounded-circle"></div>
                                    <div class="text"><a href="#">
                                            <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                                ...
                                <div class="item d-flex align-items-center">
                                    <div class="image"><img src="{{asset('admin/img/avatar-5.jpg')}}" alt="..."
                                                            class="img-fluid rounded-circle"></div>
                                    <div class="text"><a href="#">
                                            <h3 class="h5">Lorem Ipsum Dolor</h3></a>
                            ...
                            <div class="card-body no-padding">
                                ...
                                <div class="item">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#"
                                                    ...
                                                    src="{{asset('admin/img/avatar-5.jpg')}}" alt="person"
                                ...
                                <div class="item">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#"
                                                                                                 class="feed-profile"><img
                                                    src="{{asset('admin/img/avatar-2.jpg')}}" alt="person"
                                                    class="img-fluid rounded-circle"></a>
                                            <div class="content">
                                ...
                                <div class="item clearfix">
                                    <div class="feed d-flex justify-content-between">
                                        <div class="feed-body d-flex justify-content-between"><a href="#"
                                                                                                 class="feed-profile"><img
                                                    src="{{asset('admin/img/avatar-3.jpg')}}" alt="person"
                                                    class="img-fluid rounded-circle"></a>
                                            <div class="content">
