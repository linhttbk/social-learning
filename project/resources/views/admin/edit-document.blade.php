    ...
    <div class="content-inner">
        ...
        <section class="tables">
            <div class="container-fluid">
                <div class="wrapper">
                    {{--form--}}
                    <form enctype="multipart/form-data" method="post" action="{{$document->id}}" id="form" class="form" onsubmit="return OnsubmitClick()">
                        <fieldset>
                            <div class="widget">
                                <div class="title">
                                    <img class="titleIcon" src="">
                                    <h6>Cập nhật tài liệu {{$document->name}}</h6>
                                </div>
                                    ...
                                    <div class="tab_content pd0" style="display: block;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="subject_reg" name="subject_reg" tabindex="1">
                                                <@foreach($allSubject as $sub)
                                                        <option class="fs-option" <?php if ($sub->title == $subject_reg) echo "selected"?>>{{$sub->title}}
                                                            </option>
                                                        }
                                                @endforeach
                                            </select>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="document_link" id="document_link" tabindex="2"
                                                   class="form-control" placeholder="Link tài liệu" value="{{$document->url}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="document_des" id="document_des" tabindex="3" 
                                                   class="form-control" placeholder="Mô tả tài liệu" value="{{$document->des}}">
