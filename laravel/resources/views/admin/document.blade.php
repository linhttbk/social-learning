...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('admin/css/document.css')}}">
...
@section('content')
    <div class="content-inner">
        ...
        <section class="tables">
            <div class="container-fluid">
                <div>
                    <div id="title-card">Thống kê</div>
                    <div class="row">
                        <div class="col-lg-4" id="total-user">
                            @if(isset($totalDocument))
                                <div class="card">
                                    {{'Tổng số tài liệu: '.$totalDocument}}
                                </div>
                        ...
                        <div class="col-lg-4" id="add-new-user">
                            ...
                            <div class="card" id="card-add-user">
                                <a id="add-user" href="{{route('add_doccument')}}" style="display: inline-block">
                    ...
                    <div>
                        <div id="title-card">
                            <div style="display: inline-block;">Dữ liệu</div>
                            @include('errors.note')
                            <div style=" display: block">
                                ...
                                <table class="table table-striped table-hover">
                                    <tr>
                                        <th>
                                            <div class="col-sm-9">
                                                <select name="subject" id="subject" class="form-control mb-3"
                                                        onchange="initSelectValueDocument()">
                                        ...
                                        <th>
                                            <div class="col-sm-9" id="1" style="display: block;">
                                                <select id="subject_reg1" class="form-control mb-3"
                                                        onchange="initSelectValueDocumentReg()">
                                                    <option value="Toán 10" id="toan" selected="selected">Toán 10
                                                    </option>
                                            ...
                                            <div class="col-sm-9" id="2" style="display: none;">
                                                <select id="subject_reg2" class="form-control mb-3"
                                                        onchange="initSelectValueDocumentReg()">
                                            ...
                                            <div class="col-sm-9" id="4" style="display: none;">
                                                <select id="subject_reg4" class="form-control mb-3"
                                                        onchange="initSelectValueDocumentReg()">
                                            ...
                                            <div class="col-sm-9" id="3" style="display: none;">
                                                <select id="subject_reg3" class="form-control mb-3"
                                                        onchange="initSelectValueDocumentReg()">
                                                    <option id="hoa" value="Hóa Học 10" selected="selected">hóa 10
                                                    </option>
                                            ...
                                            <div class="col-sm-9" id="5" style="display: none;">
                                                <select id="subject_reg5" class="form-control mb-3"
                                                        onchange="initSelectValueDocumentReg()">
                                                    <option id="anh" value="Tiếng Anh 10" selected="selected">tiếng anh
                                                        10
                                                    </option>
                                            ...
                                            @if(isset($document_pagination))
                                                @foreach($document_pagination as $key => $data)
                                                    <tr>
                                                        <td>{{$data->id}}</td>
                                                        <td>{{$data->title}}</td>
                                                        <td><a href="{{$data->url}}"> link tài liệu tham khảo</a></td>
                                                        <td>{{$data->des}}</td>
                                                        <td>{{\App\Models\User::find($data->uid)->name}}</td>
                                                        @if ($data->status==1)
                                                            <td>Đã duyệt</td>
                                                        @else
                                                            <td>Chưa duyệt</td>
                                                        @endif
                                                        <td>
                                                            <a href="{{route('edit_document', ['id'=>$data->id])}}"><img
                                                                    src="{{asset('admin/img/icon/ic_edit.png')}}"></a>
                                                            <a href="{{route('delete_document', ['id'=>$data->id])}}"><img
